...
function writeToggleControl(idx, byId)
{
	...
	{
		if(byId)
			document.writeln('<span class="smallfonteng10">English<input style="display:none;" type="radio" value="English" name="'+strName+'"onclick=\'setEnglishById("'+idx+'")\'>&#1575;&#1585;&#1583;&#1608;<input type="radio" value="Urdu" checked name="'+strName+'" onclick=\'setUrduById("'+idx+'")\'></span>');		
	}
	else
	{
...
function insertToggleControl(idx, byId)
{
	...
	if(arguments.length >1)
	{
		if(byId)
		{
			...
			//asadvar toggleSpan= document.createElement("span");
			//asadtoggleSpan.innerHTML='English<input type="radio" value="English" name="'+strName+'"onclick=\'setEnglishById("'+idx+'")\'>&#1575;&#1585;&#1583;&#1608;<input type="radio" value="Urdu" checked name="'+strName+'" onclick=\'setUrduById("'+idx+'")\'>';
