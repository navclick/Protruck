...
GO
PRINT N'Creating [dbo].[FK_Expense_ExanaduCompanies]...';


GO
ALTER TABLE [dbo].[Expense] WITH NOCHECK
    ADD CONSTRAINT [FK_Expense_ExanaduCompanies] FOREIGN KEY ([EcomID]) REFERENCES [dbo].[ExanaduCompanies] ([Id]);
...
GO
ALTER TABLE [dbo].[Expense] WITH CHECK CHECK CONSTRAINT [FK_Expense_ExanaduCompanies];
