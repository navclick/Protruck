...
ALTER TABLE [dbo].[vehicle]
    ADD [IsContractorVehicle] BIT NULL,
        [ContractorId]        INT NULL;


GO
PRINT N'Creating [dbo].[FK_vehicle_Contractor]...';


GO
ALTER TABLE [dbo].[vehicle] WITH NOCHECK
    ADD CONSTRAINT [FK_vehicle_Contractor] FOREIGN KEY ([ContractorId]) REFERENCES [dbo].[Contractor] ([Id]);
...
GO
ALTER TABLE [dbo].[vehicle] WITH CHECK CHECK CONSTRAINT [FK_vehicle_Contractor];
