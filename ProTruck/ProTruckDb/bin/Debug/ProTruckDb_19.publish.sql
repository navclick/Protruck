...
GO
PRINT N'Creating [dbo].[FK_Cities_ExanaduCompanies]...';


GO
ALTER TABLE [dbo].[Cities] WITH NOCHECK
    ADD CONSTRAINT [FK_Cities_ExanaduCompanies] FOREIGN KEY ([EcomID]) REFERENCES [dbo].[ExanaduCompanies] ([Id]);
...
GO
ALTER TABLE [dbo].[Cities] WITH CHECK CHECK CONSTRAINT [FK_Cities_ExanaduCompanies];
