...
GO
/*
The type for column Status in table [dbo].[Drivers] is currently  INT NULL but is being changed to  BIT NULL. Data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[Drivers])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Altering [dbo].[Drivers]...';


GO
ALTER TABLE [dbo].[Drivers] ALTER COLUMN [Status] BIT NULL;
